...
$sql="SELECT * FROM registration2 WHERE StudentID='1'";
$result=mysqli_query($conn,$sql);
$score="SELECT AVG(Score) FROM test WHERE StudentID='#'";
$result2=mysqli_query($conn,$score);
$showCourse="SELECT CourseName,List_of_Actvy,StartTime,DueDate,CompletedeDate FROM course WHERE StdudentID='#'";
                ...
                <div class="col-sm-12">
                    <div class="bg-picture text-center">
                        ...
                        <div class="profile-info-name">
                            ...
                            <img src="#https://i.ytimg.com/vi/YCaGYUIfdy4/maxresdefault.jpg" class="thumb-lg img-circle img-thumbnail" alt="profile-image-was-here">
                            <!--<h3 class="text-white">Student12</h3>-->
                             <?php
                    ...
                    <div class="pull-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                ...
                                <li><a href="update.php">Remove</a></li>
                                <li class="divider"></li>
                                    ...
                                    <div class="panel panel-default panel-fill">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="about-info-p m-b-0">
                                                ...
                                                <br>
                                                <!--<p class="text-muted">sample address</p>-->
                                                 <?php
                                    ...
                                    <div class="timeline-2">
                                        <div class="time-item">
                                            <div class="item-info">
                                                ...
                                                <?php
                                                while($row=mysqli_query_fetch_array($result3))
                                                {
                                                    echo "<p>".$row['CourseName']."</p>";
                                                    echo "<p>".$row['List_of_Actvy']."</p>";
                                                   echo "<p>".$row['StartTime']."</p>";
                                                     echo "<p>".$row['DueTime']."</p>";
                                                     echo "<p>".$row['CompletedTime']."</p>";
                                                }
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="panel-body">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="Daniel Doe" id="Guardiansname" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="AboutMe">About </label>
                                            <textarea style="height: 125px" id="AboutMe" class="form-control">This is all the infos about the student which is important ...........</textarea>
                                        </div>
